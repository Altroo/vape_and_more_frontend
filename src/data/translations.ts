...
export const translations = {
	fr: {
		...
		shops: {
			...
			intro: 'Visitez notre boutique Vape & More et restez informés des prochaines adresses.',
			address: 'Adresse',
			hours: 'Horaires',
			current: 'Ouverte',
			comingSoon: 'À venir',
	...
	ar: {
		...
		shops: {
			kicker: 'أين تجدوننا',
			title: 'متجرنا',
			intro: 'زوروا متجر Vape & More وترقبوا مواقعنا القادمة.',
			address: 'العنوان',
			hours: 'ساعات العمل',
			current: 'مفتوح',
			comingSoon: 'قريبا',
	...
	en: {
		...
		shops: {
			kicker: 'Find us',
			title: 'Our Store',
			intro: 'Visit our Vape & More store and stay tuned for future locations.',
			address: 'Address',
			hours: 'Hours',
			current: 'Open',
	...
	es: {
		...
		shops: {
			...
			intro: 'Visita nuestra tienda Vape & More y mantente atento a futuras ubicaciones.',
			address: 'Dirección',
			hours: 'Horario',
			current: 'Abierta',
